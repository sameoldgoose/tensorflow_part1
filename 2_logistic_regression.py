...
test_accuracy = tf.reduce_mean(tf.keras.metrics.categorical_accuracy(y_test, y_pred_test))
...
sample = np.expand_dims(sample, axis=0)  # Reshape to match model input shape
